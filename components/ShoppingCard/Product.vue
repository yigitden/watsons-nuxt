<template>
  ...
  >
    ...
    <div class="w-2/3 text-sm flex flex-col space-y-6 pl-2">
      <p class="font-medium text-coal">{{ productName }}</p>
      <div
        class="text-graphene flex flex-row items-start items-center justify-between w-full"
      >
...
<script>
export default {
  props: ["productName", "productPrice", "productImage"],
  data() {
    return {
      count: 1,
    };
